...
experiment_name=dist_entropy_Qwen2.5-0.5B
...
# Paths
model_path=$HOME/jyh/llm_models/Qwen/Qwen2.5-0.5B
...
train_files=${data_path}/dapo-math-17k.parquet
...
#    -- python3 -m recipe.dist_entropy.main_dist_entropy \
PYTHONUNBUFFERED=1 \
    python3 -m recipe.dist_entropy.main_dist_entropy \
